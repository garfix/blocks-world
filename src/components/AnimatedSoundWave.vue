<template>
    <svg id="wave" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="-5 0 60 38.05" fill="#ffffff">
...
// thanks to Rachel McGrane @ https://codepen.io/rachelmcgrane/pen/VexWdX
</script>
